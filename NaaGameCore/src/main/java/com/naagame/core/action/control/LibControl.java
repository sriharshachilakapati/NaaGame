...
public class LibControl {
    ...
    public static final ActionDefinition<SetScore> SET_SCORE = new SetScore.Definition();
    public static final ActionDefinition<SetLives> SET_LIVES = new SetLives.Definition();
}
